...
namespace Datos
{
    public class ConexionSQL
    {
        ...
        static string conexion = "SERVER = localhost ;PORT=3306 ;DATABASE = bdTienda ;UID=root;PASSWORD=;";

        //Creamos una instancia de la clase con MySQL
        MySqlConnection con = new MySqlConnection(conexion);

        // Sql para ventana de login
        //Verifica si el nombre de usuario y ontraseña se encuentra en la tabla persona
